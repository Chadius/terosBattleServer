...
type AttackingEffect struct {
	...
	CanCounterattack          bool	`json:"can_counterattack" yaml:"can_counterattack"`
	CounterattackToHitPenalty int	`json:"counterattack_penalty" yaml:"counterattack_penalty"`
}
